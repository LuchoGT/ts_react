...
export const Header = (): JSX.Element => {
  ...
  const openMenuLogin=()=>setIsMenuLoginOpen(true);
  const closeMenuLogin=()=>setIsMenuLoginOpen(false);
  ...
  return (
    <header className="header">
      ...
      <ul className="logged__list">
        <li className="logged__item logged__item--header">
          {/* <img src={logo} alt='logo' className="logged__image"/> */}
          <div onClick={()=>closeMenuLogin()} className="logged__close">
        ...
        <li className="logged__item">
          <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V192c0-35.3-28.7-64-64-64H80c-8.8 0-16-7.2-16-16s7.2-16 16-16H448c17.7 0 32-14.3 32-32s-14.3-32-32-32H64zM416 272a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"/></svg>
          <p>Saldo</p>
          <span>0,00 PEN</span>
        </li>
        <li className="logged__item">
        ...
        <li className="logged__item">
          <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"><path d="M96 64c0-35.3 28.7-64 64-64H416c35.3 0 64 28.7 64 64V448h64c17.7 0 32 14.3 32 32s-14.3 32-32 32H432 144 32c-17.7 0-32-14.3-32-32s14.3-32 32-32H96V64zM384 288a32 32 0 1 0 0-64 32 32 0 1 0 0 64z"/></svg>
          <p>Cerrar sesion</p>
        </li>
      </ul>
    </div>
