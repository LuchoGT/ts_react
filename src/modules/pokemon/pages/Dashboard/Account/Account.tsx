...
export const Account = () => {
  return (
    ...
    <div className="general__container">
        <h1 className='general--title'>Informacion General</h1>
        <div className='general__profile'>
          <h2 className='general__profile-title'>Perfil</h2>
          <div className='general__profile-user'>
            <p>luchito@gmail.com</p>
        ...
        <div className='general__wallet'>
            <h5>Saldo Total</h5>
            <p>0,00 PEN</p>
        </div>
        <div className='general__shopping'>
          <h2 className='general__shoppping-title'>Ultimas compras</h2>
          <div className='general__shopping-container'>
            <div className='general__shopping-null'>
